...
def build_cycle_decision_diagnostics(
    ...
    *,
    ...
    diagnostics = {
        ...
        "scanner_shortlist_count": selected_symbols,
        "full_decision_count": decisions_created,
        "target_decision_count": target_decision_symbols,
        "paper_follow_conversion_count": followed,
        "paper_follow_conversion_pct": funnel["auto_follow_user_conversion_pct"],
