    ...
    def _raw_entry_action_from_context(
        ...
        *,
        ...
        decision_gate_context = {
            ...
            "policy": "Raw opportunity entries only hard-block invalid quotes, explicitly untradeable symbols, and hard untradeable liquidity; market evidence drives score and label.",
        }
        ...
        confluence["tier"] = str(RAW_ENTRY_MODEL_VERSION).upper()
        ...
        return _json_dumps(
            {
                ...
                "action_policy": {
                    "BUY": f"{RAW_ENTRY_MODEL_VERSION} marked the symbol ENTRY_READY after truth checks and raw opportunity evidence",
                    "SELL": "existing long position plus hard stop, take-profit, or time stop from position rules",
                    "HOLD": "raw opportunity model returned WATCH or NO_TRADE, an existing position is already open, or a truth check failed",
                },
                "score_breakdown": score_breakdown,
